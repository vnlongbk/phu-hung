        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed">
              Chuyên sản xuất và cung cấp các loại chả giò, chả lụa, pate và đặc sản truyền thống Việt Nam
              chất lượng cao với hơn 25 năm kinh nghiệm trong ngành thực phẩm.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Chả Giò</a></li>
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Chả Lụa</a></li>
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Chả Bò</a></li>
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Chả Chiên</a></li>
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Pate</a></li>
              <li><a href="#" className="text-slate-300 hover:text-amber-400 transition-colors">Giò</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-slate-300">123 Đường ABC, Quận 1</p>
                  <p className="text-slate-300">TP. Hồ Chí Minh, Việt Nam</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:0123456789" className="text-slate-300 hover:text-amber-400 transition-colors">0123 456 789</a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@phuhung.vn" className="text-slate-300 hover:text-amber-400 transition-colors">info@phuhung.vn</a>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="text-slate-400 hover:text-amber-400 transition-colors">Chính sách bảo mật</a>
              <a href="#" className="text-slate-400 hover:text-amber-400 transition-colors">Điều khoản sử dụng</a>
              <a href="#" className="text-slate-400 hover:text-amber-400 transition-colors">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
